...
{
public:
  void setup(const VkDevice& device, const VkPhysicalDevice& physicalDevice, nvvk::ResourceAllocator* allocator, uint32_t queueFamily, std::vector<std::string> defaultSearchPaths);
  void destroy();
